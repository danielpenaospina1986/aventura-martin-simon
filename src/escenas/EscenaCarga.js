...
import frenteBus1 from '../assets/frente/bus1.png';
import frenteBus2 from '../assets/frente/bus2.png';
...
export class EscenaCarga extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image(TEXTURAS.frenteBus1, frenteBus1);
    this.load.image(TEXTURAS.frenteBus2, frenteBus2);
